...
<div>
    @if($user->games()->count())
            ...
            <div class="py-6 mx-2 inline-block w-1/3">
                <div class="flex max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
                    ...
                    <div class="w-2/3 p-4">
                        ...
                        <div class="mt-3">
                            @if(isset($game->metadata['platforms']))
                                @foreach($game->metadata['platforms'] as $platform)
                                    <div class="inline-block px-3 py-2 my-1 bg-gray-800 text-white text-xs font-bold uppercase rounded">
                                        {{ $platform['name'] }}</div>
                                @endforeach
                            @endif
                        ...
                        <div class="flex item-center justify-between mt-3">
                            <button class="px-3 py-2 bg-purple-800 text-white text-xs font-bold uppercase rounded">Play game</button>
                        </div>
                    </div>
                </div>
            </div>
